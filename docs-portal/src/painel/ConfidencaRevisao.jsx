...
export default function ConfidencaRevisao() {
  ...
  const NIVEIS_COR = {
    MUITO_BAIXA: { bg: "#f8d7da", texto: "#721c24" },
    BAIXA: { bg: "#f5c6cb", texto: "#721c24" },
    MEDIA: { bg: "#fff3cd", texto: "#856404" },
    ALTA: { bg: "#d4edda", texto: "#155724" },
    MUITO_ALTA: { bg: "#c3e6cb", texto: "#155724" },
  };
    ...
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
      ...
      {aba === "stats" && stats && (
        ...
        >
          ...
          <div style={{ padding: "20px", background: "#d4edda", borderRadius: "4px" }}>
            <h3>Revisados</h3>
            <p style={{ fontSize: "32px", fontWeight: "bold", margin: "10px 0" }}>
              {stats.revisados}
            </p>
          ...
          <div style={{ padding: "20px", background: "#fff3cd", borderRadius: "4px" }}>
            <h3>Pendentes</h3>
            <p style={{ fontSize: "32px", fontWeight: "bold", margin: "10px 0" }}>
              {stats.pendentes}
            </p>
