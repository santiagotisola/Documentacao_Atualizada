...
- Name: portal.spec.js >> Consulta de Infrações Anônima >> deve exibir validação de CPF inválido
- Location: tests\e2e\portal.spec.js:22:3
...
Call log:
  - waiting for locator('main input[placeholder*="CPF"]').or(locator('main input').first())
