...
sidebar_position: 1
title: Equipamentos
description: Cadastro dos equipamentos de pesagem
---
...
Cadastro dos equipamentos de pesagem. Estes registros são fundamentais para o funcionamento do sistema de pesagem.
