...
| **2021~2022** | AxTon implementa `InfractionLimitAxlePBT = 50.000` | Use Configuração reconhece o threshold de 50t |
...
| **18/05/2026** | Pesagem SJW1J10 (#2911) | InfractionType=1 (ExcessAxle) — ✅ correto para Use Configuração vigente |
...
| **Conforme Use Configuração atual?** | **✅ CORRETO** | **Gerado sob Use Configuração anterior** |
...
1. **ALTERAÇÃO DE Configuração parâmetro `InfractionLimitAxlePBT` foi alterado entre as duas datas
...
| # | Pesagem | Data | PBT Const. | Excesso PBT | Excesso Eixo | Type Gravado | Use Configuração vigente | Status |
|---|:-------:|------|:----------:|:-----------:|:------------:|:------------:|:------------:|:------:|
| 1 | #1541 | 05/05/2025 13:17 | 31.200 | +750 | E3E4 +1.075 | 2 (ExcessAxlePBT) | Limite < 29.000 | ✅ (para Use Configuração da época) |
| 2 | #2911 | 18/05/2026 15:27 | 31.850 | +1.400 | E3E4 +1.725 | 1 (ExcessAxle) | Limite = 50.000 | ✅ (para Use Configuração atual) |

#### OXY6J95 (1 pesagem)

| # | Pesagem | Data | PBT Const. | Excesso PBT | Excesso Eixo | Type Gravado | Use Configuração vigente | Status |
|---|:-------:|------|:----------:|:-----------:|:------------:|:------------:|:------------:|:------:|
| 1 | #2863 | 17/04/2026 23:41 | 33.000 | +2.550 | E3E4 +1.725 | 2 (ExcessAxlePBT) | Limite < 29.000 | ✅ (para Use Configuração da época) |

#### Conclusão Comparativa

| Evidência | SJW1J10 | OXY6J95 |
|-----------|:-------:|:-------:|
| Pesagem ANTES da mudança de Use Configuração | #1541 (05/05/2025) → ExcessAxlePBT | #2863 (17/04/2026) → ExcessAxlePBT |
| Pesagem APÓS a mudança de Use Configuração | #2911 (18/05/2026) → ExcessAxle ✅ | *(sem pesagem posterior)* |
| Prova de alteração de Use Configuração | ✅ Sim (mesma placa, resultados diferentes) | ✅ Sim (resultado anterior sob Use Configuração diferente) |
...
#### ✅ Infrações coerentes com a Use Configuração vigente: **899 casos** (98,4% do total)
...
|-------|---------|------|:--------------:|:--------------:|:---------:|
| OXY6J95 | #2863 | **17/04/2026** | 2 (ExcessAxlePBT) | -68313 | Gerada sob Use Configuração anterior |
| SJW1J10 | #1541 | **05/05/2025** | 2 (ExcessAxlePBT) | -68313 | Gerada sob Use Configuração anterior |
| SJW1J10 | #2911 | **18/05/2026** | 1 (ExcessAxle) | -68312 | ✅ Correto para Use Configuração atual |
...
| # | Dispositivo Legal | O que exige | Use Configuração AxTon | Código Weighing.cs | Dados Reais (2934 pesagens) | Conformidade |
|---|-------------------|-------------|:------------:|:------------------:|:---------------------------:|:------------:|
...
| 3 | Art. 1º, §1º | ≤ 50t → fiscalizar APENAS PBT | `InfractionLimitAxlePBT = 50.000` | Checa só eixo para ≤50t | Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Configuração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração' define: checa só eixo | ✅ Config aplicada |
| 4 | Art. 1º, §2º | Se exceder PBT → TAMBÉM eixo | *(implícito)* | Depende do limite Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Configuração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração' | Só ativa se PBT > limite | ✅ Config aplicada |
| 5 | Art. 5º, II | NÃO pode fiscalizar eixo sem PBT | *(sem Use Configuração específica)* | Depende do limite Use Configuração | 2 casos a verificar | ⚠️ Verificar |
...
| Situação | Use Configuração atual | Sistema faz | Placas ref. | Casos reais | Status |
|----------|-----------|-------------|:-----------:|:-----------:|:------:|
| Excesso PBT + excesso eixo | Checa só eixo (PBT ≤ 50.000) | ExcessAxle (-68312) | SJW1J10 #2911 ✅ | 13 | ✅ Use Configuração aplicada |
| Excesso PBT + excesso eixo Use Configuração anterior) | Checava eixo+PBT (limite < 29.000) | ExcessAxlePBT (-68313) | OXY6J95, SJW1J10 #1541 | 814 | Congelado |
...
```
OXY6J95 #2863 (17/04/2026): InfractionType=2, InfractionCode=-68313 Use Configuração anterior: limite < 29.000]
SJW1J10 #1541 (05/05/2025): InfractionType=2, InfractionCode=-68313 Use Configuração anterior: limite < 29.000]
SJW1J10 #2911 (18/05/2026): InfractionType=1, InfractionCode=-68312 ✅ Use Configuração atual: limite = 50.000]
```
...
| Explicação | Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Use 'Configuração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração'uração' antiga (checava PBT+Eixo) | Config atual (checa só eixo) |
...
|-------|:--------:|:---------:|------------------|
| **SJW1J10** | 2 | 1 ExcessAxlePBT + 1 ExcessAxle | Prova de alteração de Use Configuração (mesma placa, resultados diferentes) |
| **OXY6J95** | 1 | 1 ExcessAxlePBT | Referência de comportamento sob Use Configuração anterior |
...
| Pesagens com Infração | 914 |
| Infrações coerentes com Use Configuração vigente | 899 (98,4%) |
| Infrações com tipo divergente Use Configuração anterior vs atual) | 13 (1,4%) |
| Casos a verificar (eixo sem excesso PBT) | 2 (0,2%) |
| Período de divergência | Pesagens geradas após alteração de Use Configuração |
| Último resultado sob Use Configuração anterior | OXY6J95 em 17/04/2026 |
| Primeiro resultado sob Use Configuração atual | IAI3781 em 05/05/2026 |
...
|---|------|:----------:|:------:|
| 1 | Confirmar com área de negócio se Use Configuração atual (50.000) está correta | 🟡 MÉDIA | Pendente |
...
| Pesagem #2911 (2026) — ExcessAxle | ✅ Correto para Use Configuração atual |
| Pesagem #1541 (2025) — ExcessAxlePBT | ⚠️ Gerada sob Use Configuração diferente (irrecuperável) |
...
>
> Se houver dúvida se PBT deveria valer para Veículos abaixo de 50t (nenhum Veículo de até 50t recebe Infração de PBT com a Use Configuração atual), isso precisa ser validado com a área de negócio.

---

## 9. Referências

- **Lei 14.229/2021**: [Planalto - Lei 14.229/2021](https://www.planalto.gov.br/ccivil_03/_ato2019-2022/2021/lei/l14229.htm)
- **MP 1.050/2021**: [Planalto - MPV 1050/2021](https://www.planalto.gov.br/ccivil_03/_ato2019-2022/2021/Mpv/mpv1050.htm)
