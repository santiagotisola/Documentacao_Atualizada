...
const ROTAS_PUBLICAS = [
  ...
  { method: "GET",  path: "/varco/relatorio/download" },
  // Validation Manager - Rotas públicas para permitir acesso do painel
  { method: "POST", path: "/validation/start" },
  { method: "POST", path: "/validation/discover-ui" },
  { method: "POST", path: "/validation/discover-api" },
  { method: "GET",  path: "/validation/report" },
  { method: "GET",  path: "/validation/list" },
  // Visual Validation - Rotas públicas para validação visual completa
  { method: "POST", path: "/visual-validation/start" },
  { method: "GET",  path: "/visual-validation/status" },
