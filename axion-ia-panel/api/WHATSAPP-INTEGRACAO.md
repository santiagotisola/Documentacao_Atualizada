...
3. Se score >= 0.65 → criar ticket e enviar sugestão para revisar no Use Dashboard
4. Se score < 0.65 → criar ticket e colocar na fila de escalamento
```

---

## 13. Use Dashboard (axion-ia-panel) — Novas Telas
