...
function PorSite({ embedded = false, siteContexto = null }) {
  ...
  // Pré-selecionar site e aba quando há contexto ativo
  useEffect(() => {
    if (siteContexto?.id) {
      setFiltroSite(siteContexto.id);
      setTab('por-site');
    }
  }, [siteContexto?.id]);
      ...
      <div className="ch-page">
        ...
        {siteContexto && !loading && !erro && (
          <div style={{
            ...
            <span>📌</span>
            <span>Filtrando por contexto ativo: <strong>{siteContexto.nome}</strong></span>
            <button
              onClick={() => { setFiltroSite(''); setTab('overview'); }}
