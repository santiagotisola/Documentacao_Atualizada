...
export default function Conformidade() {
  ...
  async function carregarLista() {
    ...
    setSelecionado(null);
    try {
      const r = await fetch(`${API}/conformidade?produto=${produto}`);
  ...
  async function carregarDetalhe(id) {
    ...
    setSelecionado(null);
    try {
      const r = await fetch(`${API}/conformidade/${id}`);
      const d = await r.json();
      setSelecionado(d);
  ...
  async function processarArquivo(file) {
    ...
    try {
      const r = await fetch(`${API}/doc/upload-contexto`, { method: "POST", body: data });
      if (!r.ok) {
  ...
  async function gerarRelatorio() {
    ...
    try {
      const r = await fetch(`${API}/conformidade/gerar`, {
        method: "POST",
