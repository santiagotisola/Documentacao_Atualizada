...
const modulos = [
  ...
  { icone: '⚠️', titulo: 'Tipos de Ocorrências', desc: 'Categorias de alerta', link: '/docs/operacoes/veiculos-monitorados', cor: '#e74c3c' },
  { icone: '🔔', titulo: 'Alertas', desc: 'Regras e notificações', link: '/docs/operacoes/alertas', cor: '#f39c12' },
  { icone: '🏷️', titulo: 'Classificações', desc: 'Tipos de veículos', link: '/docs/operacoes/veiculos-monitorados', cor: '#9b59b6' },
  { icone: '📥', titulo: 'Importação', desc: 'Veículos e equipamentos', link: '/docs/operacoes/veiculos-monitorados', cor: '#1abc9c' },
  { icone: '🖥️', titulo: 'Equipamentos', desc: 'Cadastro e grupos', link: '/docs/cadastros/locais', cor: '#34495e' },
  ...
  { icone: '🔎', titulo: 'Rastreamento de Placas', desc: 'Busca por placa específica', link: '/docs/relatorios/relatorio-passagens', cor: '#d35400' },
  { icone: '📋', titulo: 'Ocorrências e Alertas', desc: 'Histórico de detecções', link: '/docs/relatorios/relatorio-passagens', cor: '#7f8c8d' },
  { icone: '📄', titulo: 'PDFs Gerados', desc: 'Relatórios exportados', link: '/docs/relatorios/relatorio-passagens', cor: '#95a5a6' },
  ...
  { icone: '🔄', titulo: 'Sincronização', desc: 'Sync de passagens', link: '/docs/sistema/configuracoes', cor: '#00b894' },
];
