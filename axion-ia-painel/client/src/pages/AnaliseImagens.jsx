                ...
                <div style={{ display: "flex", gap: "6px", position: "relative" }}>
                  ...
                  <div style={{ position: "relative", flexShrink: 0 }}>
                    <button type="button" onClick={() => setCmpPresetsAberto(p => !p)}
                      ...
                      style={{ height: "34px", padding: "0 8px", background: "var(--surface-raised)", color: "var(--text-secondary)",
                    ...
                    {cmpPresetsAberto && (
                      <div style={{ position: "absolute", right: 0, top: "calc(100% + 4px)", zIndex: 100, width: "300px",
                        ...
                        boxShadow: "var(--card-shadow)", padding: "10px", display: "flex", flexDirection: "column", gap: "6px" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px", flexWrap: "wrap" }}>
                ...
                <div style={{ display: "flex", gap: "6px", alignItems: "center", flexShrink: 0 }}>
                  ...
                  <details style={{ position: "relative" }}>
                    <summary style={{ listStyle: "none", cursor: "pointer", fontSize: "11px", color: "var(--accent)", padding: "2px 8px",
                      border: "1px solid var(--accent)", borderRadius: "6px", background: "var(--accent-subtle)", userSelect: "none" }}>
                      📖 Legenda
                    </summary>
                    <div style={{ position: "absolute", right: 0, top: "calc(100% + 6px)", zIndex: 50, width: "380px",
                      background: "var(--surface)", border: "1px solid var(--border)", borderRadius: "10px", boxShadow: "var(--card-shadow)", padding: "14px" }}>
                      <div style={{ fontWeight: "700", fontSize: "12px", color: "var(--text)", marginBottom: "10px" }}>📖 Como interpretar os resultados</div>
