...
const SERVICOS = [
  ...
  { icon: "🧪", titulo: "Validação Sistemas", desc: "Testes automatizados",      link: "/validation-manager", cor: "#a855f7", cat: "Análise" },
  { icon: "🎯", titulo: "Validação Visual",  desc: "CRUD + Screenshots",       link: "/visual-validation", cor: "#ec4899", cat: "Análise" },
